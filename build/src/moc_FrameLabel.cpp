...
void FrameLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FrameLabel::*_t)(MouseData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameLabel::newMouseData)) {
                *result = 0;
            }
        }
        {
            typedef void (FrameLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameLabel::onMouseMoveEvent)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FrameLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_FrameLabel.data,
      qt_meta_data_FrameLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
