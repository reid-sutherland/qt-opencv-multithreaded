...
QT_MOC_LITERAL(4, 58, 8) // "statData"

    },
    "CaptureThread\0updateStatisticsInGUI\0"
    "\0ThreadStatisticsData\0statData"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CaptureThread::*_t)(ThreadStatisticsData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureThread::updateStatisticsInGUI)) {
                *result = 0;
            }
        }
    }
